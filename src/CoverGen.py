...
if __name__ == '__main__':
    ...
    with gr.Blocks(title='CoverGen - AndikSoft (v1)') as app:
        ...
        with gr.Tab("Связаться со мной"):
            ...
            gr.Markdown("<center><h1>Добро пожаловать в CoverGen - AndikSoft (v1)</h1></center>")
            with gr.Row():
                with gr.Column():
                    gr.HTML("<center><h2><a href='https://www.youtube.com/channel/UCE8QtQCSHAtElck2B3Hi-gA'>YouTube: AndikSoft</a></h2></center>")
